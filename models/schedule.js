...
module.exports = (sequelize, DataTypes) => {
  class Schedule extends Model {
    ...
    static associate(models) {
      ...
      Schedule.belongsTo(models.User, { foreignKey: 'doctorId', targetKey: 'id', as: 'nameDoctor' })
      Schedule.hasOne(models.Booking, { foreignKey: 'id', targetKey: 'scheduleId', as: 'scheduleData' })
